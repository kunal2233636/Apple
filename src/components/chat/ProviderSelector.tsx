...
const PROVIDER_CONFIG = {
  ...
  openrouter: {
    ...
    icon: Globe,
    color: 'bg-green-500',
    description: 'Unified AI API gateway - All Free Models',
    strength: 'Variety & Free',
    models: [
    ...
    features: ['Multiple Models', 'Cost Optimization', 'Free Tier'],
  },
  gemini: {
    name: 'Google Gemini',
    icon: Sparkles,
  ...
  mistral: {
    ...
    models: ['mistral-7b-instruct', 'mistral-small-latest', 'mistral-medium-latest'],
    features: ['Open Source', 'Multilingual', 'Free Models'],
  },
  cohere: {
    name: 'Cohere',
    icon: Shield,
